...
class RelationCreateView(BaseView):
    ...
    def post(self, request):
        try:
            ...
            return self.response(message='Wrong Request', status=400)
        
        try:
            relation = FollowRelation.objects.get(follower=request.user)
        except FollowRelation.DoesNotExist:
            relation = FollowRelation.object.create(follower=request.user)
        ...
        try:
            ...
            return self.response(massage='Wrong Request', status=400)
